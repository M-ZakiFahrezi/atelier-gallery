...
<section style="max-width:620px; margin:auto;">
    ...
    <form action="{{ route('admin.event.store') }}" method="POST"
        ...
        <div style="margin-bottom:16px;">
            ...
            <input type="text" name="nama_pameran" value="{{ old('nama_pameran') }}"
                   required
        ...
        <div style="margin-bottom:16px;">
            ...
            <input type="text" name="lokasi_pameran" value="{{ old('lokasi_pameran') }}"
                   required
                   style="width:100%; padding:10px 12px; border:1px solid #ccc; border-radius:8px;">
        ...
        <div style="margin-bottom:18px;">
            ...
            <select name="id_galeri" required
                ...
                @foreach($galeri as $g)
                    <option value="{{ $g->id_galeri }}" {{ old('id_galeri') == $g->id_galeri ? 'selected' : '' }}>
                        {{ $g->nama_galeri }}
                    </option>
                @endforeach
            </select>
