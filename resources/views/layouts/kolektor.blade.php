...
<body>
    ...
    <nav>
        ...
        <ul id="navMenu">
            <li><a href="{{ route('kolektor.home') }}" class="{{ request()->routeIs('kolektor.home') ? 'active' : '' }}">Home</a></li>
            <li><a href="{{ route('kolektor.arts') }}" class="{{ request()->routeIs('kolektor.arts') ? 'active' : '' }}">Arts</a></li>
            <li><a href="{{ route('kolektor.artists') }}" class="{{ request()->routeIs('kolektor.artists') ? 'active' : '' }}">Artists</a>
            </li>
            <li><a href="{{ route('kolektor.gallery') }}" class="{{ request()->routeIs('kolektor.gallery') ? 'active' : '' }}">Gallery</a>
            </li>
            <li><a href="{{ route('kolektor.leaderboard') }}"
                    class="{{ request()->routeIs('kolektor.leaderboard') ? 'active' : '' }}">Leaderboard</a></li>
            <!-- khusus kolektor -->
            <li>
                <a href="{{ route('kolektor.event') }}"
                class="{{ request()->routeIs('kolektor.event') ? 'active' : '' }}">
                    Event
                </a>
            </li>

            <li><a href="{{ route('kolektor.contact') }}"
                    class="{{ request()->routeIs('kolektor.contact') ? 'active' : '' }}">Contact</a>
            </li>
            <li>
